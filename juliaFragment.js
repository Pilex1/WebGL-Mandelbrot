...
"		z = ctan(z);",
"	} else if (mode == 5) {",
"		z = cpow(z, CNum(var1, 0.0));",
"	} else if (mode == 6) {",
"		z = csin(z);",
"	} else if (mode == 7) {",
"		z = clog(z, CNum(var1, 0.0));",
"	} else if (mode == 8) {",
"		z = cdiv(cln(z), ctan(z));",
"	} else if (mode == 9) {",
"		z = cmul(crecpcl(z), clog(z, CNum(var1, 0.0)));",
"	}",
...
"	c = CNum(vc.x, vc.y);",
"",
"	float iter = calcIter(CNum(z.x, z.y));",
